...
<meta charset="utf-8">
      <title>RS Bank</title>
    <link href="assets/images/Rs1.png" rel="icon">
   <link href="assets/images/Rs1.png" rel="apple-touch-icon">
                            ...
                            <div class="row">  
                                ...
                                <div class="col-sm-6 col-md-6 col-xs-12">  
                                    <div class="form-group">  
                                        ...
                                        <input type="tel" id="aadhaar" name="aadhaar" pattern="^\d{12}$"  placeholder="Enter Your NID card "class="form-control"  required />  
                                        <div class="invalid-feedback">  
                                        Please Enter Your NID card
                                        </div>
