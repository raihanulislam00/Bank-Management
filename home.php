...
<nav class="navbar navbar-expand-xl navbar-light bg-light">
	<a href="home.php" class="navbar-brand"><img src="images/Rs1.png" width="45" alt="" class="logo-img"><b>RS Bank</b></a>
      ...
      <section class="light">
		...
		<article class="postcard light blue">
			<a class="postcard__img_link" href="#">
				<img class="postcard__img" src="images/Rs1.png" alt="Image Title" />
			</a>
			<div class="postcard__text t-dark">
				<h1 class="postcard__title blue"><a href="#">🥳 আরএস ব্যাংকে স্বাগতম!</a></h1>
				
				<div class="postcard__bar"></div>
				<div class="postcard__preview-txt"><b>🏦 আরএস ব্যাংক</b> বাংলাদেশের সবচেয়ে বড় বেসরকারি বাণিজ্যিক ব্যাংক। এটি একটি বেসরকারি খাতের ব্যাংক এবং এর প্রধান কার্যালয় ঢাকার কুরিলে অবস্থিত। সারাদেশের প্রায় প্রতিটি শহরে এর ১৬টি আঞ্চলিক হাব এবং ৫৭টি জোনাল অফিস রয়েছে।</div>
